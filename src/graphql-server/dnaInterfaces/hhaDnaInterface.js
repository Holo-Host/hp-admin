...
export const HhaDnaInterface = {
  currentUser: {
    create: (host_doc) => {
      console.log("host_doc inside hhaDnaInterface", host_doc);
      createZomeCall('host/register_as_host')({host_doc})
    },
  ...
  happs: {
    ...
    disable: (app_hash) => createZomeCall('host/disable_app')({app_hash}),
