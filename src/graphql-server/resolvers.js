...
export const resolvers = {
  ...
  Mutation: {
    ...
    holofuelAcceptManyOffers: (_, { transactionIdArray }) => HoloFuelDnaInterface.offers.acceptMany(transactionIdArray),

    holofuelAcceptAllOffers: () => HoloFuelDnaInterface.offers.acceptAll(),
