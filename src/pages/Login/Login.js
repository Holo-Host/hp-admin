...
export default function Login ({ history: { push } }) {
  ...
  >
    <div styleName='container'>
      ...
      <div styleName='reminder-text-block'>*Remember, Holo doesn’t store your password so we can’t recover it for you. So save your password securely!</div>
      <div styleName='reminder-text-block'><a styleName='reminder-text' href='www.wheredoesthisgo.com'>Learn more</a> about controlling your own data.</div>
    </div>
  </PrimaryLayout>
}
